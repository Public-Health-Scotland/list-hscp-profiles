...
-   **`r perc_single_discount`%** of dwellings received a single-occupant council tax discount, and **`r perc_exempt`%** were exempt from council tax entirely.
...
```{r }
ftext(paste0("Table ", table_num, ": Breakdown of dwelling types by year for ", HSCP, " HSCP."), table_heading_style)
...
```{r fig.width = 7, fig.height = 2, warning = FALSE, fig.cap = 'A bar graph showing the proportion of Households in each council tax band for the HSCP for the most recent year'}
ftext(paste0("Figure ", figure_num, ": Breakdown of households by council tax band for ", HSCP, " in ", max_year_housing, "."), table_heading_style)
...
```{r }
ftext(paste0("Table ", table_num, ": Percentage of households by council tax band for ", HSCP, " in ", max_year_housing, "."), table_heading_style)
